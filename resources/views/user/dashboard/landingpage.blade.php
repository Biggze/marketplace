    ...
    <div class="container mx-auto px-4 flex flex-col md:flex-row items-center">
        <div class="md:w-1/2 mb-8 md:mb-0">
            <h1 class="text-4xl md:text-5xl font-bold mb-4 text-gray-800">
                Temukan Sepatu Impianmu di <span class="text-green-500">ShoeMarket</span>
            </h1>
            <p class="text-lg text-gray-600 mb-6">
                Marketplace sepatu online dengan koleksi terlengkap, harga terbaik, dan kualitas terjamin. Belanja sepatu jadi lebih mudah dan menyenangkan!
            </p>
            <a href="/products/1" class="bg-green-500 text-white px-6 py-3 rounded font-semibold hover:bg-green-600 transition duration-300">
                Jelajahi Produk
            </a>
        </div>
...
<section class="py-12 bg-gray-50">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Sneakers -->
            <a href="/products/1" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition flex flex-col items-center group">
                <div class="bg-green-100 rounded-full p-6 mb-4 group-hover:scale-110 transition">
            ...
            <!-- Running -->
            <a href="/products/2" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition flex flex-col items-center group">
                <div class="bg-blue-100 rounded-full p-6 mb-4 group-hover:scale-110 transition">
            ...
            <!-- Formal -->
            <a href="/products/3" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition flex flex-col items-center group">
                <div class="bg-yellow-100 rounded-full p-6 mb-4 group-hover:scale-110 transition">
...
<section class="py-12 bg-green-500">
    <div class="container mx-auto px-4 text-center">
        ...
        <a href="/products/1" class="bg-white text-green-500 px-6 py-3 rounded font-semibold hover:bg-gray-100 transition duration-300">Lihat Promo</a>
    </div>
</section>
